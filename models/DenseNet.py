# Implementation: https://github.com/soeaver/pytorch-priv/blob/master/models/imagenet/se_densenet.py
...
class SE_DenseNet(nn.Module):
    def __init__(self, growthRate=32, head7x7=True, dropRate=0,
        ...
        if self.head7x7:
            self.conv1 = nn.Conv2d(4, headplanes * 2, 7, 2, 3, bias=False)
            self.bn1 = nn.BatchNorm2d(headplanes * 2)
        else:
            self.conv1 = nn.Conv2d(4, headplanes, 3, 2, 1, bias=False)
